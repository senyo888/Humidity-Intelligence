...
HUMIDIFIER_RECONCILE_CONFIRM_SECONDS = 15
HUMIDIFIER_RECONCILE_RETRY_DELAYS_SECONDS = (30, 120)
HUMIDIFIER_RECONCILE_MAX_ATTEMPTS = 3
HUMIDIFIER_RECONCILE_HISTORY_LIMIT = 8
